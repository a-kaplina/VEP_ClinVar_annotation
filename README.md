...
Скрипт  обрабатывает VCF файл с генетическими вариантами, добавляет к ним аннотации (VEP, ClinVar, PharmGKB), фильтрует по клинической значимости и создаёт итоговые таблицы для анализа.
...
Шаг 8: Добавление PharmGKB аннотаций
...
Шаг 11: Статистика по патогенности
    ...
    Создаёт таблицу с подсчётом различных классов клинической значимости и статусов рецензирования
...
Шаг 16 & 17: Создание длинных таблиц
