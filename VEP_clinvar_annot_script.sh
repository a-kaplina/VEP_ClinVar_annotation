...
log "  [9] *_real_clnsig_counts.txt - pathogenicity summary (after filterng out of reference homozygotes)"
log "  [10] *_vus_clnsig_counts.txt - VUS summary (after filterng out of reference homozygotes)"
log ""
